...
const FounderApplicationForm = ({ onBack }: FounderApplicationFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Submitting founder application:', formData);
      ...
      // Step 2: Insert into founder_application_details
