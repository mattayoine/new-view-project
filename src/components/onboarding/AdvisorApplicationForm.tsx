...
const AdvisorApplicationForm = ({ onBack }: AdvisorApplicationFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Submitting advisor application:', formData);

      // Step 1: Insert into base_applications
      ...
      if (baseError) {
        ...
        throw new Error(`Failed to submit application: ${baseError.message}`);
      }

      console.log('Base application created:', baseApplication);

      // Step 2: Insert into advisor_application_details
      ...
      if (detailsError) {
        console.error('Advisor details error:', detailsError);
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-700">
                    I consent to being named in a final public pilot deck
                  </span>
                </label>
              </div>
              ...
              >
                {isSubmitting ? 'Submitting...' : 'Submit Advisor Application'}
              </Button>
            </form>
          </CardContent>
        </Card>
...
export default AdvisorApplicationForm;
