...
interface NewAdvisorFormProps {
  onBack: () => void;
}

const NewAdvisorForm = ({ onBack }: NewAdvisorFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Starting advisor application submission...');
      ...
      // Step 2: Insert into advisor_application_details table
              ...
              <div>
                <label className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-700">
                    I'm comfortable being featured in public profiles and case studies
                  </span>
                </label>
              </div>
