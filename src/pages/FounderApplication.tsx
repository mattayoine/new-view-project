  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl text-blue-600">Apply as a Founder</CardTitle>
            <p className="text-gray-600">Join the CoPilot pilot program and get matched with experienced advisors.</p>
          </CardHeader>
          <CardContent>
